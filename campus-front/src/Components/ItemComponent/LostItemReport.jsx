...
const LostItemReport = () => {
    ...
    lostItemList()
      .then((response) => {
        ...
        if (userRole === 'Admin') {
          ...
          const userItems = allItems.filter(item => item.username === currentUser && !item.status);
  ...
  useEffect(() => {
    const username = sessionStorage.getItem('currentUser') || localStorage.getItem('currentUser');
    if (username) {
