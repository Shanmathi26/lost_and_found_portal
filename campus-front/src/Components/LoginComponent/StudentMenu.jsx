      ...
      <div className="dashboard-header">
        <div className="header-content">
          ...
          <div className="header-actions">
            ...
            {/* <button className="chat-btn" onClick={() => navigate('/chat-list')} style={{backgroundColor: '#3498db', color: 'white', border: 'none', padding: '0.5rem 1rem', borderRadius: '0.25rem', cursor: 'pointer'}}>💬 Chat</button> */}
            <NotificationBell />
      ...
      <div className="dashboard-content">
        <div className="quick-actions">
          ...
          <div className="action-buttons">
            ...
            <button className="action-btn primary" onClick={() => navigate('/broadcast-chat')} style={{backgroundColor: '#3498db'}}>
              💬 Campus Chat
            </button>
          </div>
        </div>
